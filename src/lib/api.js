 ...
 * In production (Vercel) NEXT_PUBLIC_API_URL is empty — routes are same-origin /api/...
 * In local dev, set NEXT_PUBLIC_API_URL=http://localhost:5000 in .env.local to use
 * the standalone Express server, OR leave it empty to use the Next.js API routes.
 */
